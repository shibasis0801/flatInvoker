...
@JsExport
class OptionsHandler<In: Request, Out: Response>(
    route: String,
    ...
    ServiceEndpoint.http(HttpMethod.OPTIONS, route, operation), requestSerializer, responseSerializer, handler
) {
    @JsExport.Ignore
    operator fun provideDelegate(
        thisRef: Service,
        property: KProperty<*>,
    ): ReadOnlyProperty<Service, OptionsHandler<In, Out>> =
