...
export declare interface AuditableDto {
    data: any/* JsonElement */;
    createdAt: any/* Instant */;
    updatedAt: any/* Instant */;
    readonly __doNotUseOrImplementIt: {
        readonly "dev.shibasis.reaktor.auth.AuditableDto": unique symbol;
    };
}
export declare class App implements AuditableDto {
    constructor(id: string, name: string, data: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */);
    get id(): string;
    get name(): string;
    get data(): any/* JsonElement */;
    set data(value: any/* JsonElement */);
    get createdAt(): any/* Instant */;
    set createdAt(value: any/* Instant */);
    get updatedAt(): any/* Instant */;
    set updatedAt(value: any/* Instant */);
    copy(id?: string, name?: string, data?: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */): App;
    toString(): string;
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
    readonly __doNotUseOrImplementIt: AuditableDto["__doNotUseOrImplementIt"];
}
...
export declare class Entity implements AuditableDto {
    constructor(id: string, name: string, appId: string, data: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */);
    get id(): string;
    get name(): string;
    get appId(): string;
    get data(): any/* JsonElement */;
    ...
    get updatedAt(): any/* Instant */;
    set updatedAt(value: any/* Instant */);
    copy(id?: string, name?: string, appId?: string, data?: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */): Entity;
    toString(): string;
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
    readonly __doNotUseOrImplementIt: AuditableDto["__doNotUseOrImplementIt"];
...
export declare namespace Entity {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        const constructor: abstract new () => Entity;
    }
}
export declare abstract class UserStatus {
    private constructor();
    static get ONBOARDING(): UserStatus & {
        get name(): "ONBOARDING";
        get ordinal(): 0;
    };
    ...
    static get BANNED(): UserStatus & {
        get name(): "BANNED";
        get ordinal(): 3;
    };
    get name(): "ONBOARDING" | "ACTIVE" | "INACTIVE" | "BANNED";
    get ordinal(): 0 | 1 | 2 | 3;
    static values(): Array<UserStatus>;
    static valueOf(value: string): UserStatus;
}
export declare namespace UserStatus {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        const constructor: abstract new () => UserStatus;
    }
}
export declare abstract class UserProvider {
    ...
    get name(): "GOOGLE" | "APPLE" | "SUPABASE";
    get ordinal(): 0 | 1 | 2;
...
export declare abstract class AccountType {
    private constructor();
    static get USER(): AccountType & {
        get name(): "USER";
        get ordinal(): 0;
    };
    static get SERVICE_ACCOUNT(): AccountType & {
        get name(): "SERVICE_ACCOUNT";
        get ordinal(): 1;
    };
    get name(): "USER" | "SERVICE_ACCOUNT";
    get ordinal(): 0 | 1;
...
export declare namespace AccountType {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        const constructor: abstract new () => AccountType;
    }
}
export declare class User implements AuditableDto {
    constructor(id: string, name: string, socialId: Nullable<string>, appId: string, provider: Nullable<UserProvider>, status: UserStatus, accountType: AccountType | undefined, data: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */);
    get id(): string;
    get name(): string;
    get socialId(): Nullable<string>;
    get appId(): string;
    get provider(): Nullable<UserProvider>;
    ...
    get updatedAt(): any/* Instant */;
    set updatedAt(value: any/* Instant */);
    copy(id?: string, name?: string, socialId?: Nullable<string>, appId?: string, provider?: Nullable<UserProvider>, status?: UserStatus, accountType?: AccountType, data?: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */): User;
    toString(): string;
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
    readonly __doNotUseOrImplementIt: AuditableDto["__doNotUseOrImplementIt"];
...
export declare class Role implements AuditableDto {
    constructor(id: string, name: string, appId: string, data: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */);
    get id(): string;
    get name(): string;
    get appId(): string;
    ...
    get updatedAt(): any/* Instant */;
    set updatedAt(value: any/* Instant */);
    copy(id?: string, name?: string, appId?: string, data?: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */): Role;
    toString(): string;
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
    readonly __doNotUseOrImplementIt: AuditableDto["__doNotUseOrImplementIt"];
...
export declare class Permission implements AuditableDto {
    constructor(id: string, name: string, appId: string, data: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */);
    get id(): string;
    get name(): string;
    get appId(): string;
    ...
    get updatedAt(): any/* Instant */;
    set updatedAt(value: any/* Instant */);
    copy(id?: string, name?: string, appId?: string, data?: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */): Permission;
    toString(): string;
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
    readonly __doNotUseOrImplementIt: AuditableDto["__doNotUseOrImplementIt"];
...
export declare namespace Permission {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        const constructor: abstract new () => Permission;
    }
}
export declare class Session implements AuditableDto {
    constructor(id: string, userId: string, appId: string, contextId: Nullable<string> | undefined, principalId: Nullable<string> | undefined, expiresAt: any/* Instant */ | undefined, data: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */);
    get id(): string;
    get userId(): string;
    get appId(): string;
    ...
    get updatedAt(): any/* Instant */;
    set updatedAt(value: any/* Instant */);
    copy(id?: string, userId?: string, appId?: string, contextId?: Nullable<string>, principalId?: Nullable<string>, expiresAt?: any/* Instant */, data?: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */): Session;
    toString(): string;
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
    readonly __doNotUseOrImplementIt: AuditableDto["__doNotUseOrImplementIt"];
...
export declare namespace Session {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        const constructor: abstract new () => Session;
    }
}
export declare class Context implements AuditableDto {
    constructor(id: string, name: string, appId: string, data: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */);
    get id(): string;
    get name(): string;
    get appId(): string;
    ...
    get updatedAt(): any/* Instant */;
    set updatedAt(value: any/* Instant */);
    copy(id?: string, name?: string, appId?: string, data?: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */): Context;
    toString(): string;
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
    readonly __doNotUseOrImplementIt: AuditableDto["__doNotUseOrImplementIt"];
...
export declare class RolePermission implements AuditableDto {
    constructor(id: string, roleId: string, permissionId: string, data: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */);
    get id(): string;
    get roleId(): string;
    ...
    get updatedAt(): any/* Instant */;
    set updatedAt(value: any/* Instant */);
    copy(id?: string, roleId?: string, permissionId?: string, data?: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */): RolePermission;
    toString(): string;
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
    readonly __doNotUseOrImplementIt: AuditableDto["__doNotUseOrImplementIt"];
}
export declare namespace RolePermission {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        const constructor: abstract new () => RolePermission;
    }
}
export declare class UserRole implements AuditableDto {
    constructor(id: string, userId: string, roleId: string, contextId: string, data: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */);
    get id(): string;
    get userId(): string;
    get roleId(): string;
    ...
    get updatedAt(): any/* Instant */;
    set updatedAt(value: any/* Instant */);
    copy(id?: string, userId?: string, roleId?: string, contextId?: string, data?: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */): UserRole;
    toString(): string;
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
    readonly __doNotUseOrImplementIt: AuditableDto["__doNotUseOrImplementIt"];
...
export declare class PersonalAccessToken implements AuditableDto {
    constructor(id: string, userId: Nullable<string>, name: string, tokenHash: string, scopes: string, contextId: Nullable<string>, expiresAt: Nullable<any>/* Nullable<Instant> */ | undefined, lastUsedAt: Nullable<any>/* Nullable<Instant> */ | undefined, revokedAt: Nullable<any>/* Nullable<Instant> */ | undefined, appId: Nullable<string> | undefined, allowedAudiences: Nullable<string> | undefined, principalId: Nullable<string> | undefined, data: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */);
    get id(): string;
    ...
    get lastUsedAt(): Nullable<any>/* Nullable<Instant> */;
    get revokedAt(): Nullable<any>/* Nullable<Instant> */;
    get appId(): Nullable<string>;
    get allowedAudiences(): Nullable<string>;
    get principalId(): Nullable<string>;
    get data(): any/* JsonElement */;
    set data(value: any/* JsonElement */);
    get createdAt(): any/* Instant */;
    ...
    get updatedAt(): any/* Instant */;
    set updatedAt(value: any/* Instant */);
    copy(id?: string, userId?: Nullable<string>, name?: string, tokenHash?: string, scopes?: string, contextId?: Nullable<string>, expiresAt?: Nullable<any>/* Nullable<Instant> */, lastUsedAt?: Nullable<any>/* Nullable<Instant> */, revokedAt?: Nullable<any>/* Nullable<Instant> */, appId?: Nullable<string>, allowedAudiences?: Nullable<string>, principalId?: Nullable<string>, data?: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */): PersonalAccessToken;
    toString(): string;
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
    readonly __doNotUseOrImplementIt: AuditableDto["__doNotUseOrImplementIt"];
...
export declare namespace PersonalAccessToken {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        const constructor: abstract new () => PersonalAccessToken;
    }
}
export declare class RefreshToken implements AuditableDto {
    constructor(id: string, sessionId: string, tokenHash: string, familyId: string, principalId: Nullable<string> | undefined, previousTokenId: Nullable<string> | undefined, expiresAt: any/* Instant */, usedAt: Nullable<any>/* Nullable<Instant> */ | undefined, rotatedAt: Nullable<any>/* Nullable<Instant> */ | undefined, revokedAt: Nullable<any>/* Nullable<Instant> */ | undefined, data: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */);
    get id(): string;
    get sessionId(): string;
    get tokenHash(): string;
    get familyId(): string;
    get principalId(): Nullable<string>;
    get previousTokenId(): Nullable<string>;
    get expiresAt(): any/* Instant */;
    get usedAt(): Nullable<any>/* Nullable<Instant> */;
    get rotatedAt(): Nullable<any>/* Nullable<Instant> */;
    get revokedAt(): Nullable<any>/* Nullable<Instant> */;
    get data(): any/* JsonElement */;
    set data(value: any/* JsonElement */);
    get createdAt(): any/* Instant */;
    ...
    get updatedAt(): any/* Instant */;
    set updatedAt(value: any/* Instant */);
    copy(id?: string, sessionId?: string, tokenHash?: string, familyId?: string, principalId?: Nullable<string>, previousTokenId?: Nullable<string>, expiresAt?: any/* Instant */, usedAt?: Nullable<any>/* Nullable<Instant> */, rotatedAt?: Nullable<any>/* Nullable<Instant> */, revokedAt?: Nullable<any>/* Nullable<Instant> */, data?: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */): RefreshToken;
    toString(): string;
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
    readonly __doNotUseOrImplementIt: AuditableDto["__doNotUseOrImplementIt"];
...
export declare namespace RefreshToken {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        const constructor: abstract new () => RefreshToken;
    }
}
export declare class ServiceAccount implements AuditableDto {
    constructor(id: string, appId: string, principalId: Nullable<string> | undefined, clientId: string, name: string, authMethod: string | undefined, publicJwks: Nullable<string> | undefined, secretHash: Nullable<string> | undefined, scopes: string | undefined, allowedAudiences: string | undefined, status: string | undefined, data: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */);
    get id(): string;
    get appId(): string;
    get principalId(): Nullable<string>;
    get clientId(): string;
    ...
    get publicJwks(): Nullable<string>;
    get secretHash(): Nullable<string>;
    get scopes(): string;
    ...
    get updatedAt(): any/* Instant */;
    set updatedAt(value: any/* Instant */);
    copy(id?: string, appId?: string, principalId?: Nullable<string>, clientId?: string, name?: string, authMethod?: string, publicJwks?: Nullable<string>, secretHash?: Nullable<string>, scopes?: string, allowedAudiences?: string, status?: string, data?: any/* JsonElement */, createdAt?: any/* Instant */, updatedAt?: any/* Instant */): ServiceAccount;
    toString(): string;
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
    readonly __doNotUseOrImplementIt: AuditableDto["__doNotUseOrImplementIt"];
...
export declare namespace ServiceAccount {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        const constructor: abstract new () => ServiceAccount;
    }
}
export declare class LoginRequest extends Request.$metadata$.constructor {
    ...
    get environment(): Environment;
    set environment(value: Environment);
    copy(idToken?: string, appId?: string, provider?: UserProvider, nonce?: Nullable<string>, state?: Nullable<string>, tenantHint?: Nullable<string>, contextHint?: Nullable<string>, givenName?: Nullable<string>, familyName?: Nullable<string>, newUserProfile?: any/* JsonElement */, headers?: KtMutableMap<string, string>, queryParams?: KtMutableMap<string, string>, pathParams?: KtMutableMap<string, string>, environment?: Environment): LoginRequest;
    toString(): string;
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
...
export declare namespace LoginResponse {
    ...
    class Success extends LoginResponse.$metadata$.constructor {
        constructor(user: User, profile: any/* JsonElement */, accessToken: string, refreshToken: string, tokenSet?: TokenSet);
        get user(): User;
        get profile(): any/* JsonElement */;
        get accessToken(): string;
        get refreshToken(): string;
        get tokenSet(): TokenSet;
        copy(user?: User, profile?: any/* JsonElement */, accessToken?: string, refreshToken?: string, tokenSet?: TokenSet): LoginResponse.Success;
        toString(): string;
        hashCode(): number;
        equals(other: Nullable<any>): boolean;
    }
...
export declare class MintPatRequest extends Request.$metadata$.constructor {
    constructor(name: string, scopes?: KtList<string>, appId?: Nullable<string>, allowedAudiences?: KtList<string>, expiresInDays?: Nullable<number>, headers?: KtMutableMap<string, string>, queryParams?: KtMutableMap<string, string>, pathParams?: KtMutableMap<string, string>, environment?: Environment);
    get name(): string;
    get scopes(): KtList<string>;
    get appId(): Nullable<string>;
    ...
    get environment(): Environment;
    set environment(value: Environment);
    copy(name?: string, scopes?: KtList<string>, appId?: Nullable<string>, allowedAudiences?: KtList<string>, expiresInDays?: Nullable<number>, headers?: KtMutableMap<string, string>, queryParams?: KtMutableMap<string, string>, pathParams?: KtMutableMap<string, string>, environment?: Environment): MintPatRequest;
    toString(): string;
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
...
export declare class TokenRequest extends Request.$metadata$.constructor {
    constructor(grantType?: string, rawToken?: string, clientId?: Nullable<string>, clientSecret?: Nullable<string>, audience?: string, scopes?: KtList<string>, subjectToken?: Nullable<string>, subjectTokenType?: Nullable<string>, actorToken?: Nullable<string>, actorTokenType?: Nullable<string>, requestedTokenType?: Nullable<string>, clientAssertion?: Nullable<string>, clientAssertionType?: Nullable<string>, ttlSeconds?: number, headers?: KtMutableMap<string, string>, queryParams?: KtMutableMap<string, string>, pathParams?: KtMutableMap<string, string>, environment?: Environment);
    ...
    get environment(): Environment;
    set environment(value: Environment);
    copy(grantType?: string, rawToken?: string, clientId?: Nullable<string>, clientSecret?: Nullable<string>, audience?: string, scopes?: KtList<string>, subjectToken?: Nullable<string>, subjectTokenType?: Nullable<string>, actorToken?: Nullable<string>, actorTokenType?: Nullable<string>, requestedTokenType?: Nullable<string>, clientAssertion?: Nullable<string>, clientAssertionType?: Nullable<string>, ttlSeconds?: number, headers?: KtMutableMap<string, string>, queryParams?: KtMutableMap<string, string>, pathParams?: KtMutableMap<string, string>, environment?: Environment): TokenRequest;
    toString(): string;
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
}
...
export declare class TokenResponse extends Response.$metadata$.constructor {
    ...
    set statusCode(value: StatusCode);
    get headers(): KtMutableMap<string, string>;
    copy(accessToken?: string, tokenType?: string, expiresInSeconds?: number, tokenId?: Nullable<string>, scopes?: KtList<string>, statusCode?: StatusCode, headers?: KtMutableMap<string, string>): TokenResponse;
    toString(): string;
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
}
...
export declare class MeResponse extends Response.$metadata$.constructor {
    constructor(principalId?: Nullable<string>, principalKind?: Nullable<string>, appId?: Nullable<string>, audience?: Nullable<string>, sessionId?: Nullable<string>, scopes?: KtList<string>, actorId?: Nullable<string>, statusCode?: StatusCode, headers?: KtMutableMap<string, string>);
    get principalId(): Nullable<string>;
    ...
    set statusCode(value: StatusCode);
    get headers(): KtMutableMap<string, string>;
    copy(principalId?: Nullable<string>, principalKind?: Nullable<string>, appId?: Nullable<string>, audience?: Nullable<string>, sessionId?: Nullable<string>, scopes?: KtList<string>, actorId?: Nullable<string>, statusCode?: StatusCode, headers?: KtMutableMap<string, string>): MeResponse;
    toString(): string;
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
}
...
export declare class LogoutAllRequest extends Request.$metadata$.constructor {
    ...
    get environment(): Environment;
    set environment(value: Environment);
    copy(headers?: KtMutableMap<string, string>, queryParams?: KtMutableMap<string, string>, pathParams?: KtMutableMap<string, string>, environment?: Environment): LogoutAllRequest;
    toString(): string;
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
}
