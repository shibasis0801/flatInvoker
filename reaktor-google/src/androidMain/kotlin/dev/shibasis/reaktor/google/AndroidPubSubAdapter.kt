...
class AndroidPubSubAdapter(
    activity: ComponentActivity,
) : PubSubAdapter<ComponentActivity>(activity) {

    private val unsupported =
        "Google Pub/Sub is not implemented for Android in reaktor-google. Use the JVM or JS adapter instead."
