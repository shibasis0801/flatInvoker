...
export declare namespace HelloCounterDurableObject {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        const constructor: abstract new () => HelloCounterDurableObject;
    }
}
export declare abstract class HelloWorker {
    static readonly getInstance: () => typeof HelloWorker.$metadata$.type;
    private constructor();
}
export declare namespace HelloWorker {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        abstract class type extends KtSingleton<constructor>() {
            private constructor();
        ...
        abstract class constructor {
            fetch(request: any, env: any, executionContext: any): any;
            private constructor();
        }
    }
}