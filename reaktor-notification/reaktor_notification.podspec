Pod::Spec.new do |spec|
    spec.name                     = 'reaktor_notification'
    spec.version                  = '1.0'
    ...
    if !Dir.exist?('build/cocoapods/framework/reaktor_notification.framework') || Dir.empty?('build/cocoapods/framework/reaktor_notification.framework')
        ...
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:
            ...
            ./gradlew :reaktor-notification:generateDummyFramework
    ...
    spec.pod_target_xcconfig = {
        'KOTLIN_PROJECT_PATH' => ':reaktor-notification',
        'PRODUCT_MODULE_NAME' => 'reaktor_notification',
    }
                
    spec.script_phases = [
        {
            :name => 'Build reaktor_notification',
