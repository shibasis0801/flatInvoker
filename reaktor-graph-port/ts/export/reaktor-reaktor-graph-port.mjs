...
initMetadataForClass(AbstractMutableSet, 'AbstractMutableSet', VOID, VOID, [AbstractMutableCollection, MutableIterable, Collection, KtSet]);
...
initMetadataForClass(HashMapKeys, 'HashMapKeys', VOID, VOID, [MutableIterable, Collection, KtSet, AbstractMutableSet]);
initMetadataForClass(HashMapValues, 'HashMapValues', VOID, VOID, [Collection, MutableIterable, AbstractMutableCollection]);
initMetadataForClass(HashMapEntrySetBase, 'HashMapEntrySetBase', VOID, VOID, [MutableIterable, Collection, KtSet, AbstractMutableSet]);
...
initMetadataForClass(HashSet, 'HashSet', HashSet.new_kotlin_collections_HashSet_ovxcsm_k$, VOID, [AbstractMutableSet, MutableIterable, Collection, KtSet]);
...
initMetadataForClass(LinkedHashSet, 'LinkedHashSet', LinkedHashSet.new_kotlin_collections_LinkedHashSet_ahyf7j_k$, VOID, [HashSet, MutableIterable, Collection, KtSet]);
