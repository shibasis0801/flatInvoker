...
initMetadataForClass(AbstractMutableSet, 'AbstractMutableSet', VOID, VOID, [AbstractMutableCollection, Collection, MutableIterable, KtSet]);
...
initMetadataForClass(HashMapKeys, 'HashMapKeys', VOID, VOID, [Collection, MutableIterable, KtSet, AbstractMutableSet]);
initMetadataForClass(HashMapValues, 'HashMapValues', VOID, VOID, [MutableIterable, Collection, AbstractMutableCollection]);
initMetadataForClass(HashMapEntrySetBase, 'HashMapEntrySetBase', VOID, VOID, [Collection, MutableIterable, KtSet, AbstractMutableSet]);
...
initMetadataForClass(HashSet, 'HashSet', HashSet.new_kotlin_collections_HashSet_ovxcsm_k$, VOID, [AbstractMutableSet, Collection, MutableIterable, KtSet]);
...
initMetadataForClass(LinkedHashSet, 'LinkedHashSet', LinkedHashSet.new_kotlin_collections_LinkedHashSet_ahyf7j_k$, VOID, [HashSet, Collection, MutableIterable, KtSet]);
