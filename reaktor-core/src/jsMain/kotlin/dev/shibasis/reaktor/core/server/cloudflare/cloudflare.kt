...
package dev.shibasis.reaktor.core.server.cloudflare
...
external open class PromiseRejectionEvent(type: String, init: EventInit = definedExternally) :
    Event {
...
external open class FetchEvent(type: String, init: EventInit = definedExternally) :
    ExtendableEvent {
...
external open class Headers {
    ...
    open fun entries(): JsIterable<dynamic>
}
...
external open class Request__0 :
    Request<Any, dynamic /* IncomingRequestCfPropertiesBase & IncomingRequestCfPropertiesBotManagementEnterprise & IncomingRequestCfPropertiesCloudflareForSaaSEnterprise<Any> & IncomingRequestCfPropertiesGeographicInformation & IncomingRequestCfPropertiesCloudflareAccessOrApiShield | RequestInitCfProperties */>
...
external interface RequestInit__0 :
    RequestInit<dynamic /* IncomingRequestCfPropertiesBase & IncomingRequestCfPropertiesBotManagementEnterprise & IncomingRequestCfPropertiesCloudflareForSaaSEnterprise<Any> & IncomingRequestCfPropertiesGeographicInformation & IncomingRequestCfPropertiesCloudflareAccessOrApiShield | RequestInitCfProperties */>
...
external open class ScheduledEvent(type: String, init: EventInit = definedExternally) :
    ExtendableEvent {
...
external interface ReadableStream<R> {
    ...
    fun values(options: ReadableStreamValuesOptions = definedExternally): AsyncIterable<R>
...
external open class IdentityTransformStream(queuingStrategy: IdentityTransformStreamQueuingStrategy = definedExternally) :
    TransformStream<dynamic /* ArrayBuffer | ArrayBufferView */, Uint8Array>
...
external open class CompressionStream(format: String /* "gzip" | "deflate" | "deflate-raw" */) :
    TransformStream<dynamic /* ArrayBuffer | ArrayBufferView */, Uint8Array>

external open class DecompressionStream(format: String /* "gzip" | "deflate" | "deflate-raw" */) :
    TransformStream<dynamic /* ArrayBuffer | ArrayBufferView */, Uint8Array>

external open class TextEncoderStream : TransformStream<String, Uint8Array>

external open class TextDecoderStream(label: String = definedExternally, options: TextDecoderStreamTextDecoderStreamInit = definedExternally) :
    TransformStream<dynamic /* ArrayBuffer | ArrayBufferView */, String>
...
external open class ByteLengthQueuingStrategy(init: QueuingStrategyInit) :
...
external open class URLSearchParams {
    ...
    open fun set(name: String, value: String)
    open fun sort()
    open fun entries(): JsIterable<dynamic /* JsTuple<key> */> { definedExternally }
}
...
external interface IncomingRequestCfPropertiesBotManagementEnterprise :
...
external open class EmailEvent(type: String, init: EventInit = definedExternally) :
    ExtendableEvent {
