...
import { Color } from '../monster/color.js';
import { Equipment, unionToEquipment, unionListToEquipment } from '../monster/equipment.js';
import { Vec3, Vec3T } from '../monster/vec3.js';
import { Weapon, WeaponT } from '../monster/weapon.js';
...
unpack(): MonsterT {
  return new MonsterT(
    ...
    this.color(),
    this.bb!.createObjList<Weapon, WeaponT>(this.weapons.bind(this), this.weaponsLength()),
    this.equippedType(),
    (() => {
    ...
    this.bb!.createObjList<Vec3, Vec3T>(this.path.bind(this), this.pathLength())
  );
}
...
unpackTo(_o: MonsterT): void {
  ...
  _o.color = this.color();
  _o.weapons = this.bb!.createObjList<Weapon, WeaponT>(this.weapons.bind(this), this.weaponsLength());
  ...
  _o.path = this.bb!.createObjList<Vec3, Vec3T>(this.path.bind(this), this.pathLength());
}
}
...
constructor(
  ...
  public weapons: (WeaponT)[] = [],
  public equippedType: Equipment = Equipment.NONE,
  public equipped: WeaponT|null = null,
  public path: (Vec3T)[] = []
){}
