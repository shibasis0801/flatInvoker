...
class Companion_7 {
  constructor() {
    ...
    tmp.jd_1 = lazy(tmp_0, StatusCode$Companion$_anonymous__haxpe8);
  }
  invoke(code) {
...
initMetadataForClass(ArrayList, 'ArrayList', ArrayList.t3, VOID, [AbstractMutableList, Collection, KtList]);
