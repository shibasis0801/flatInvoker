...
(dev.shibasis.flatinvoker.react.types.SingleArgNativeFunction.invoke+10)
(dev.shibasis.flatinvoker.react.types.FlowHandle$flowJob$1$1$emit$$inlined$dispatchMain$1.invokeSuspend+76)
 */