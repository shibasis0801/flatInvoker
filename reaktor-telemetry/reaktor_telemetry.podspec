Pod::Spec.new do |spec|
    ...
    if !Dir.exist?('build/cocoapods/framework/reaktor_telemetry.framework') || Dir.empty?('build/cocoapods/framework/reaktor_telemetry.framework')
        ...
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:
            ./gradlew :reaktor-telemetry:generateDummyFramework
    ...
    spec.pod_target_xcconfig = {
        'KOTLIN_PROJECT_PATH' => ':reaktor-telemetry',
        'PRODUCT_MODULE_NAME' => 'reaktor_telemetry',
    }
    spec.script_phases = [
        {
            :name => 'Build reaktor_telemetry',
